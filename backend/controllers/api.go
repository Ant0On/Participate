...
func RegisterRoutes(r *gin.Engine) {
	...
	activity.GET("/:id/reservations/pending", GetPendingReservations)
	...
	accommodation.GET("/:id/reservations/pending", GetPendingReservations)
	...
	event.GET("/:id/reservations/pending", GetPendingReservations)
