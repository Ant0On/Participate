...
<template>
  <div class="home_offer_search">
    ...
    <SelectionInput v-model="searchOffer.offerType" label-text="Offer type" placeholder="Type" :is-required="true"
                    :items="offerTypes"/>
    <TextInput v-model="searchOffer.location" width="100%" label-text="Location" placeholder="Location"
               :is-required="true"/>
    <DateInput v-model="searchOffer.dateFrom" label-text="Date from" :is-required="true"/>
    <DateInput v-model="searchOffer.dateTo" label-text="Date to" :is-required="false"/>
    <NumberInput v-model="searchOffer.numberOfPeople" label-text="Number of people" placeholder="People"
                 :is-required="true"/>
